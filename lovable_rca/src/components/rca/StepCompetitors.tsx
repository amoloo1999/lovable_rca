...
import { Building2, MapPin, Navigation, Check, CheckSquare, Square } from 'lucide-react';
...
export function StepCompetitors({ subjectStore, competitors, onSelect, onNext, onBack }: StepCompetitorsProps) {
